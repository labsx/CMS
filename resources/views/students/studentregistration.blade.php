                            ...
                            <div class="card-body p-md-5">
                              <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                  ...
                                  <form class="mx-1 mx-md-8" action="/student" method="POST">
                                    @csrf
                  
                                    <div class="d-flex flex-row align-items-center mb-4">
                                      <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                                      <div class="form-outline flex-fill mb-0">
                                        <input type="text"  class="form-control" name="name" placeholder="Your Full Name" value="{{old ('name')}}"/>
                                        <div>
                                            @error('name')
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                      ...
                                      <div class="d-flex flex-row align-items-center mb-4">
                                        <i class="fas fa-lock fa-lg me-3 fa-fw"></i>
                                        <div class="form-outline flex-fill mb-0">
                                          <input type="text" name="guardian" class="form-control"  placeholder="Guardian" value="{{old ('guardian')}}"/>
                                          <div>
                                              @error('guardian')
                                               <p style="font-size: x-small"  class=" text-danger mb-3 text-right">{{$message}}</p>
                                               @enderror
